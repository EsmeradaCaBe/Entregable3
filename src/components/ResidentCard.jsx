    ...
    <article className='residentCard'>
        ...
        <section className='residentCard__info'>
            ...
            <ul className='residentCard__list'>
                <li className='residentCard__items'><span>Specie: </span>{residentInfo?.species}</li>
                <li className='residentCard__items'><span>Origin: </span>{residentInfo?.origin.name}</li>
                <li className='residentCard__items'><span>Episodes where appears: </span>{residentInfo?.episode.length}</li>
            </ul>
        </section>
    </article>
  )
